...
const getValue = (value) =>
    isArrayOrObject(value) ? deepCopy(value) : value;
...
const deepMerge = (dest, source) => {
    if (isObject(dest) && isObject(source)) {
        ...
        throw new Error(
            `[error] deepMerge: destination object and source object must be arrays or objects and the same type. A ${Object.prototype.toString.call(dest)} of the destination object and a ${Object.prototype.toString.call(source)} of the source object are given.`
        );
    }
};
